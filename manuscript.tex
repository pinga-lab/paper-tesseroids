...
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage[left=1in,right=1in,top=1.3in,bottom=1in]{geometry}
...
\newcommand{\Author}{Uieda, L., Barbosa, V.C.F., Braitenberg, C.}
\newcommand{\AuthorAffil}{
    ...
    \\
    {\small $^2$ Observat\'orio Nacional, Rio de Janeiro, Brazil.}
    \\
    {\small $^3$ Department of Mathematics and Geosciences, University of Trieste, Trieste, Italy}
    \\
    {\small $^*$ e-mail: leouieda@gmail.com}
}
\newcommand{\DOI}{10.1190/geo2015-0204.1}
...
\lhead{
    ...
    Uieda \textit{et al.}, 2016, doi:\DOI{}
}
...
\date{
    \normalsize
    Accepted 2016 July 11. Received in original form 2015 March 30.
    \\[0.4cm]
    This is a pre-copyedited, author-produced PDF of an article
    published in \textit{Geophysics} following peer review.
    The version of record
    ``\textit{\Author{} (2016). \Title{}. Geophysics. doi:\DOI{}}''
    is available online at: \DOILink{}.
}

\maketitle

\noindent Peer-reviewed code related to this article can be found at
\href{http://software.seg.org/2016/0004}{software.seg.org/2016/0004} or
\href{https://github.com/pinga-lab/paper-tesseroids}{github.com/pinga-lab/paper-tesseroids}.
...
the distance between point masses should not be greater than
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/figure2}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/figure3}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/figure4}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/figure5}
    \caption{
...
(see section "Code for figures and error analysis").

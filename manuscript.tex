...
The latest version can be downloaded from the official
website\footnote{http://www.leouieda.com/tesseroids}.
...
contains the \texttt{.c} files that build the command-line programs.
...
The first step in the numerical integration with the GLQ is to compute the

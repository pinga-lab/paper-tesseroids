...
% * <valeria.valcris@gmail.com> 2015-03-23T17:28:28.769Z:
%
%  Leo, the sentence "Based on this, \citet{Ku1977} proposed an empirical criterion that the distance the distance to the computation point."
%
% ^ <valeria.valcris@gmail.com> 2015-03-23T17:57:28.416Z.
adjacent point masses.
% * <valeria.valcris@gmail.com> 2015-03-23T17:29:37.800Z:
%
%  is wrong. The criterion disappeared.
%
% ^ <valeria.valcris@gmail.com> 2015-03-23T17:57:27.222Z.
...
% * <berg@units.it> 2015-03-22T10:56:54.365Z:
%
%  Leo, on the link below the digits are 6.67384, so if you truncate it should be 6.674 not 6.673 as on the wikipedia article on G.
%
% * <berg@units.it> 2015-03-22T10:54:00.463Z:
%
%  http://physics.nist.gov/cgi-bin/cuu/Value?bg|search_for=universal_in!
%
% ^ <leouieda@gmail.com> 2015-03-22T21:20:28.891Z:
%
%  That's correct, thanks. It must have been a typing error.
%
and
...
% * <berg@units.it> 2015-03-19T21:04:01.768Z:
%
%  the description of the operation of stack is not clear- is it the input tesseroid array?
%
% ^ <leouieda@gmail.com> 2015-03-20T18:02:14.018Z:
%
%  I modified the description above and added more text below as well. Is it clearer now?
%
...
\end{enumerate}
% * <valeria.valcris@gmail.com> 2015-03-23T19:53:50.437Z:
%
%  Leo, item 6b I suggest changing " warn the user of a ``stack overflow''              and compute the effect of the larger tesseroid (step 5)." by
%
The algorithm above is repeated
% * <valeria.valcris@gmail.com> 2015-03-23T21:09:58.768Z:
%
%  by "warn the user of a ``stack overflow''  and compute the effect of the tesseroid computed on the step 5."
%
...
https://github.com/pinga-lab/paper-tesseroids}\footnote{
http://dx.doi.org/10.5281/zenodo.16032}.
...
% * <berg@units.it> 2015-03-22T12:57:56.006Z:
%
%  and takethe average over the hundert points. Leo: is that correct? Should we add it to be more clear?
%
% ^ <leouieda@gmail.com> 2015-03-22T20:37:47.094Z:
%
%  No, I don't take the average. I take the largest error. I didn't mention that above because I only talk about the error further on ("Figure~\ref{fig:dist-size-curves} shows the maximum difference between the shell and tesseroid fields").
%
...
% * <berg@units.it> 2015-03-22T13:00:05.803Z:
%
%  D=0 means we are sitting in the center of the tesseroid, more than no division. Maybe you could be more precise on this, as D=0 will not happen, as you are at 2km height?
%
% ^ <leouieda@gmail.com> 2015-03-22T20:45:02.247Z:
%
%  I'm not moving the computation grid during this test. What I do is I vary the value of D used in the adaptive discretization. That's what is shown in Fig 4. Each curve corresponds to a fixed grid. Changing D just means that the adaptive discretization is performed differently because of the inequality in eq 17. Notice that if D=0, any combination of distance/size is larger than D. So there won't be any divisions.
%
...
% * <berg@units.it> 2015-03-22T13:02:41.484Z:
%
%  Not sure I understand what you did for the 30° tesseroid. Errors are nearly the same. It means that at D=1 the tesseroid has been divided into many small tesseroids so as to have the correct distance-size ratio: Already for D=.5 the calculation is made on small tesseroids that make up the big 30° tesseroid. So actually the different curves represent very similar  tesseroids in the near field, only in the far field are the tesseroids left with the large size. We see that the result is nearly the same, with a great reduction in computer time in the case of the 30° tesseroid as for distant tesseroids no division is necessary. Leo: maybe we could add this comment, if my interpretation is correct.
%
% ^ <leouieda@gmail.com> 2015-03-22T21:19:24.057Z:
%
%  Carla, your interpretation is correct. In practice there is no advantage to using large tesseroids with this algorithm because I don't take into account a finer resolution model in the near zone (like a proper near-far zone separation).  The difference is that I'm dividing a corse model into small but equivalent tesseroids. For a near-far zone separation I'd average out the fine model in the far zone.
%
...
% * <berg@units.it> 2015-03-19T21:07:33.445Z:
%
%  what is the height dependence due to? Should the distance not include height already? Is the height a second control parameter, next to the distance ratio? What is that due to? Is it only for gzz or also for the other gradient components? What about the gx?
%
% ^ <leouieda@gmail.com> 2015-03-20T18:23:53.901Z:
%
%  The height is included in the distance and is not a control variable. This happens for all tensor components but not to the potential, gx, gy, and gz. I think this is because the decay factor for the tensor components is 1/r^3 whereas the discreatization algorithm compares D to r/size. So as the  computation point becomes closer. the field increases more rapidly than the algorithm increases the  amount of discretization. That is why you need higher D (more discretization) when you are closer to the tesseroid.
%
% ^ <berg@units.it> 2015-03-22T13:32:27.725Z:
%
%  hello Leo: are you sure D<2 is what he is calculating at 260km height? if it is a 1° tesseroid and you are at 260km height, your distance is greater than the biggest sidelength of the tesseroid, and maybe that is why the error starts to decrease for D>2.5, because for smalle D your condition is satisfied by itself .
%
% ^ <leouieda@gmail.com> 2015-03-22T21:14:00.081Z:
%
%  That is exactly it. For 1º tesseroids at 260km, there are no divisions for D < 2 because the condition is already satisfied. That's why the error curve is flat.
%
...
% * <leouieda@gmail.com> 2015-03-20T18:43:18.571Z:
%
%  I have modified the above paragraph to try to explain why the ratio for gzz varies with height.
%

...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Divide the tesseroid in half along each dimension that failed
             the condition.
        \item Check if the number of new elements plus \emph{stktop}
...
\emph{matplotlib} by \citet{Hunter2007} for graphs,
and \emph{Mayavi} by \citet{Ramachandran2011} for 3D graphs.

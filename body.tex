...
We must establish reference values to evaluate the error of the numerical
integration.

The homogeneous spherical shell is a convenient geometry with analytical
solutions for
the gravitational potential, attraction, and gravity gradient tensor \citep{Grombein2013}
...
Table~\ref{tab:shell} contains the parameters defining the spherical shell.

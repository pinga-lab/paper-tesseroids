...
The computation point can be considered at any longitude and latitude because of
...
Making the comparison between the tesseroid


We perform the computations on an $11 \times 11$ point regular grid.
